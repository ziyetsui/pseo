...
import { Corner, Drift, Marquee, Plaque, Ticker } from "./variants";
...
/* Round three. Drift keeps slot one as the reference; the other four are the
   copy cut you asked for, at four settings. Only the first screen switches —
   the real Anthology body below is mounted once by page.tsx and stays put. */
const VARIANTS = [
  { name: "Drift", render: Drift },
  { name: "Marquee", render: Marquee },
  { name: "Ticker", render: Ticker },
  { name: "Plaque", render: Plaque },
  { name: "Corner", render: Corner },
] as const;
