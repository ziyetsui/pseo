/* PROTOTYPE — /proto/model-hero
 *
 * Round three. Nothing in production imports this directory. Delete the whole
...
export const metadata: Metadata = { title: "Prototype · model page first screen", robots: "noindex, nofollow" };
